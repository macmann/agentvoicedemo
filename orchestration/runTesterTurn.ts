...
export async function runTesterTurn(input: RunTesterTurnInput): Promise<RunTesterTurnOutput> {
  ...
  return {
    ...
    metadata: {
      ...
      postToolEndpointType: responseGeneration.endpointPath,
      postToolFallbackOccurred: responseGeneration.fallbackOccurred,
      postToolFailureCategory: responseGeneration.failureCategory,
      postToolFailureStatusCode: responseGeneration.failureStatusCode,
      postToolFailureResponseBody: responseGeneration.failureResponseBody,
      postToolRequestPayloadBuilt: responseGeneration.requestPayloadBuilt,
      postToolStructuredSchemaUsed: responseGeneration.structuredSchemaUsed,
      postToolJsonSchemaValidationRequested: responseGeneration.jsonSchemaValidationRequested,
      groundedToolResultUsed: Boolean(groundedToolResponse),
      groundedSupportIntent: responseContext.supportIntent,
      groundedToolName: responseContext.toolName,
      groundedMatchedRegion: responseContext.matchedRegion,
      groundedMatchedCategory: responseContext.matchedCategory,
      groundedOverallStatus: responseContext.overallStatus,
      groundedServiceStatus: responseContext.serviceStatus,
      groundedClarificationNeeded: responseContext.clarificationNeeded,
      groundedClarificationPrompt: responseContext.clarificationPrompt,
      ...
      preToolUsageStatus,
      preToolUsageReason,
      preToolProviderSelectionReason: state.preToolUnderstandingDiagnostics?.providerSelectionReason,
      preToolEndpointType: state.preToolUnderstandingDiagnostics?.endpointPath,
      preToolFallbackOccurred: state.preToolUnderstandingDiagnostics?.fallbackOccurred,
      preToolFailureCategory: state.preToolUnderstandingDiagnostics?.failureCategory,
      preToolFailureStatusCode: state.preToolUnderstandingDiagnostics?.failureStatusCode,
      preToolFailureResponseBody: state.preToolUnderstandingDiagnostics?.failureResponseBody,
      preToolStructuredSchemaUsed: state.preToolUnderstandingDiagnostics?.structuredSchemaUsed,
      preToolRequestPayloadBuilt: state.preToolUnderstandingDiagnostics?.requestPayloadBuilt,
      preToolJsonSchemaValidationRequested: state.preToolUnderstandingDiagnostics?.jsonSchemaValidationRequested,
      preToolIntentConfidence: state.preToolUnderstanding?.intentConfidence,
      preToolRescueMappingApplied: state.preToolUnderstandingDiagnostics?.rescueMappingApplied,
