...
export interface TesterDebugState {
  ...
  postToolEndpointType?: string;
  postToolFallbackOccurred?: boolean;
  postToolFailureCategory?: string;
  postToolFailureStatusCode?: number;
  postToolFailureResponseBody?: string;
  postToolRequestPayloadBuilt?: boolean;
  ...
  preToolEndpointType?: string;
  preToolFallbackOccurred?: boolean;
  preToolFailureCategory?: string;
  preToolFailureStatusCode?: number;
  preToolFailureResponseBody?: string;
  preToolStructuredSchemaUsed?: boolean;
  preToolRequestPayloadBuilt?: boolean;
  preToolJsonSchemaValidationRequested?: boolean;
